...
import Nowald from "./Index/Nowald";
import Dortineinemanderen from "./Index/Dortineinemanderen";
...
const whatToRender = name => {
  switch (name) {
    ...
    case "nowald":
      return <Nowald />
    case "dortineinemanderen":
      return <Dortineinemanderen />
    default:
...
const project = {
  ...
  nowald: Nowald,
  dortineinemanderen: Dortineinemanderen,
};
const Project = () => {
